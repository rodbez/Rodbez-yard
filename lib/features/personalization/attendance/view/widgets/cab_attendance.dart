...
class CabAttendance extends StatelessWidget {
  const CabAttendance({super.key});
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text("${item['present']}", style: const TextStyle(fontSize: 14)),
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 5),
                            Text("${item['absent']}", style: const TextStyle(fontSize: 14)),
                          ],
                        ),
                      ],
                    ),
